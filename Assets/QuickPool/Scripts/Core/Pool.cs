    ...
    public class Pool
    {
        ...
        public void Initialize()
        {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                GameObject obj = PrefabUtility.InstantiatePrefab(((Object)prefab)) as GameObject;
                obj.transform.position = m_Root.position;
                obj.transform.rotation = m_Root.rotation;
#if UNITY_EDITOR
